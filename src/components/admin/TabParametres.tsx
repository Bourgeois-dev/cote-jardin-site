    ...
    <>
      ...
      <div className="contenu"><div className="bloc">
        ...
        <div className="grid2" style={{ marginTop: 18 }}>
          ...
          <div className="ligne-toggle"><span className="lib"><b>Liste d'attente</b><span>Quand un créneau est complet, propose au client de s'inscrire sur la liste d'attente.</span></span><span className="toggle"><input type="checkbox" checked={s.waitlist_enabled || false} onChange={(e) => setS({ ...s, waitlist_enabled: e.target.checked })} /><span className="piste" /></span></div>
          <div className="ligne-toggle"><span className="lib"><b>Rappel J-1 automatique</b><span>Envoie un email de rappel la veille de chaque réservation (inclut un lien d'annulation).</span></span><span className="toggle"><input type="checkbox" checked={s.reminder_enabled !== false} onChange={(e) => setS({ ...s, reminder_enabled: e.target.checked })} /><span className="piste" /></span></div>
        </div>
