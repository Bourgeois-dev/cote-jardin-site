        ...
        <>
          ...
          {step === 3 && (
            <div>
              ...
              {proposeNewsletter && (
                <label className="consent"><input type="checkbox" checked={newsletterOptin} onChange={(e) => setNewsletterOptin(e.target.checked)} /><span>Je souhaite aussi recevoir les actualités du restaurant par e-mail. Désinscription possible à tout moment.</span></label>
              )}
