...
export interface ReservationSettings { id: string; phone_threshold: number; min_advance_hours: number; slot_duration: number; booking_horizon_days: number; enabled: boolean; newsletter_optin: boolean; max_covers_per_slot: number | null; waitlist_enabled: boolean; reminder_enabled: boolean; table_duration: number; auto_confirm: boolean; auto_confirm_same_day: boolean; auto_confirm_block_noshow: number; }
